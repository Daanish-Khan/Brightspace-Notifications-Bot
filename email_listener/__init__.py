...
class EmailListener:
    ...
    def listen(self, timeout, h, process_func=write_txt_file, **kwargs):
    ...
    def __idle(self, h, process_func=write_txt_file, **kwargs):
        ...
        while (get_time() < inner_timeout):
            ...
            print(datetime.now().strftime("%H:%M") + " Server sent:", responses if responses else "nothing")
